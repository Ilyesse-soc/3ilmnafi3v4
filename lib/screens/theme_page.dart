...
class _ThemePageState extends State<ThemePage> {
  ...
  void _onVideoAdded() {
    ...
    if ((data['themes'] as List).contains(widget.videosPath)) {
      setState(() {
        localVideos.add(
          Video(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Builder(
                        builder: (context) {
                          // Pour Tawhid, n'afficher que les vidéos locales
                          if (widget.theme.toLowerCase().contains('tawhid')) {
                            final allVideos = localVideos;
                            ...
                            return GridView.count(
                              ...
                              children: subList.map((sub) {
                                return ElevatedButton(
                                  ...
                                  onPressed: () {
                                    // Afficher uniquement les vidéos locales pour la sous-catégorie
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                            ...
                            // Comportement normal pour les autres thèmes
                            return FutureBuilder<List<Video>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final allVideos = (snapshot.data ?? []) + localVideos;
                                final Set<String> subs = {};
                                for (var v in allVideos) {
                                  for (var s in v.subcategories) {
                                    final st = s.toString().trim();
              ...
              return Padding(
                ...
                child: Column(
                  children: [
                      ...
                      child: Stack(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(video.imageUrl ?? '', fit: BoxFit.cover, width: double.infinity),
                          ),
                          if (isSeen)
                            Positioned(
                              bottom: 6,
                    ...
                    SizedBox(height: 16),
                    Text(video.title, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    SizedBox(height: 16),
                    ElevatedButton.icon(
