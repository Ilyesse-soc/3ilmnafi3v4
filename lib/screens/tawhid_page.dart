...
class _TawhidPageState extends State<TawhidPage> {
  void _shareVideo(String videoTitle) async {
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text('Partager la vidéo', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              const SizedBox(height: 16),
              ElevatedButton.icon(
                icon: Icon(Icons.apple),
                label: Text('Lien Apple'),
                onPressed: () {
                  Share.share('Regarde cette vidéo sur 3ilmNafi3: $videoTitle\n\nhttps://apps.apple.com/fr/app/3ilmnafi3/id6742595997');
              ...
              ElevatedButton.icon(
                ...
                label: Text('Lien Play Store'),
                onPressed: () {
                  Share.share('Regarde cette vidéo sur 3ilmNafi3: $videoTitle\n\nhttps://play.google.com/store/apps/details?id=com.ilmnafi3.app&pcampaignid=web_share');
                  Navigator.pop(context);
                },
              ),
            ],
